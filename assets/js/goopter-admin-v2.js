...
jQuery(document).ready(function ($) {
    ...
    $('#pfw-bulk-action-target-type').change(function () {
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-category').hide();
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-product-type').hide();
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-price-value').hide();
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-stock-value').hide();
        ...
        if ($(this).val() == 'where')
        {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-type').show();
            $('#pfw-bulk-action-target-where-type').attr('required', 'required');
        } else
        {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-type').hide();
    ...
    $('#pfw-bulk-action-type').change(function () {
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-payment-action-type').hide();
        $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-payment-authorization-type').hide();
        if ($(this).val() == 'enable_payment_action') {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-payment-action-type').show();
        }
    }).change();
    ...
    $('#pfw-bulk-action-payment-action-type').change(function () {
        if ($(this).val() == 'Authorization') {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-payment-authorization-type').show();
        } else {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-payment-authorization-type').hide();
        }
    }).change();
    ...
    $('#pfw-bulk-action-target-where-type').change(function () {
        ...
        {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-category').show();
        ...
        {
            $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-product-type').show();
        ...
        } else
        {
            ...
            {
                $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-price-value').show();
            ...
            } else if ($(this).val() == 'stock_greater' || $(this).val() == 'stock_less')
            {
                $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-price-value').hide();
                $('#pfw-bulk-action-target-where-price-value').removeAttr('required');
                $('.goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce-shipping-tools-bulk-action-section.pfw-bulk-action-target-where-stock-value').show();
