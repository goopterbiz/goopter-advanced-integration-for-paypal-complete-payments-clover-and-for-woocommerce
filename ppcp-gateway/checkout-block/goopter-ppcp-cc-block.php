...
final class Goopter_PPCP_CC_Block extends AbstractPaymentMethodType {
    ...
    public function get_payment_method_script_handles() {
        ...
        if (goopter_ppcp_has_active_session()) {
            $order_button_text = apply_filters('goopter_ppcp_cc_order_review_page_place_order_button_text', __('Confirm Your PayPal Order', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
        } else {
        ...
        if (function_exists('wp_set_script_translations')) {
            wp_set_script_translations('goopter_ppcp_cc-blocks-integration', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
        }
