...
if ($jsonResponse['status']) {
    ...
    <?php echo esc_html( __( 'Add Domain', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ) ); ?>
    </h4>
    ...
    <div class="border-box" style="border: 1px solid #c3c4c7;padding: 8px;">
        ...
        <?php echo esc_html(__('Please ensure that the following link is accessible in order to verify the domain. When you click the link you should see a separate page load with a bunch of numbers displayed. This means it is accessible.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce')); ?>
            echo '<br />';
            <?php echo esc_html(__('Once you have verified the page is accessible, click the Add Domain button. Your domain will then show up in the list below, and this means you are ready to accept Apple Pay on your website!', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce')); ?>
            ?><br /><br />
    ...
    <h4 style="margin-bottom: 7px;" class="center"><?php echo esc_html( __( 'Domains in Your PayPal Account', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ) ); ?></h4>
    <table class="wp-list-table widefat fixed striped table-view-list apple-pay-domain-listing-table">
        <tr><th><?php echo esc_html( __( 'Domain Name', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ) ); ?></th><th><?php echo esc_html( __( 'Action', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ) ); ?></th></tr>
        <?php
                ...
                <tr>
                    ...
                    <td>
                        <a class="goopter_apple_pay_remove_api_call"
                            ...
                            <?php esc_html_e( 'Delete', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ); ?>
                        </a>
                    </td>
                </tr>
            <?php }
        } else {
            echo '<tr class="no-apple-pay-domains-in-account"><td colspan="2">' . esc_html( __( 'No domains registered yet.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ) ) . '</td></tr>';
        }?>
    </table>
