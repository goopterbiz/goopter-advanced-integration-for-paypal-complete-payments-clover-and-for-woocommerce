...
class Goopter_PayPal_PPCP_Smart_Button {
    ...
    public $goopter_ppcp_currency_list;
    public $goopter_ppcp_currency;
    ...
    public function __construct() {
        ...
        if (defined('WCU_WP_PLUGIN_NAME')) {
            add_filter('woocommerce_currency', array($this, 'goopter_ppcp_woocommerce_currency'), 99999);
        }
        $this->goopter_ppcp_default_set_properties();
    ...
    public function goopter_ppcp_get_properties() {
        ...
        $this->order_review_page_title = apply_filters('goopter_ppcp_order_review_page_title', __('Complete Order Payment', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
        $this->order_review_page_description = apply_filters('goopter_ppcp_order_review_page_description', __("<strong>You're almost done!</strong><br>Review your information before you place your order.", 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
        ...
        $this->advanced_card_payments_title = $this->setting_obj->get('advanced_card_payments_title', 'Debit or Credit Card');
        ...
        add_action( 'wp', function() {
            if (empty($this->pay_later_messaging_page_type)) {
                ...
                $page = goopter_ppcp_pay_later_messaging();
    ...
    public function goopter_ppcp_default_set_properties() {
        $this->goopter_ppcp_currency_list = array('AUD', 'BRL', 'CAD', 'CZK', 'DKK', 'EUR', 'HKD', 'INR', 'ILS', 'JPY', 'MYR', 'MXN', 'TWD', 'NZD', 'NOK', 'PHP', 'PLN', 'GBP', 'RUB', 'SGD', 'SEK', 'CHF', 'THB', 'USD');
    ...
    public function goopter_ppcp_smart_button_style_properties() {
    ...
    public function goopter_ppcp_add_hooks() {
        ...
        add_action('admin_init', array($this, 'goopter_ppcp_admin_init'), 100);
        add_filter('script_loader_tag', array($this, 'goopter_ppcp_clean_url'), 10, 2);
        add_action('wp_loaded', array($this, 'goopter_ppcp_session_manager'), 999);
        add_filter('the_title', array($this, 'goopter_ppcp_endpoint_page_titles'));
        add_action('woocommerce_cart_emptied', array($this, 'maybe_clear_session_data'));
        add_action('woocommerce_checkout_init', array($this, 'goopter_ppcp_checkout_init'));
        ...
        add_action('wp_loaded', array($this, 'goopter_ppcp_block_set_address'), 999);
        add_action('woocommerce_cart_shipping_packages', array($this, 'maybe_add_shipping_information'), 999);
        add_filter('body_class', array($this, 'goopter_ppcp_add_class_order_review_page'));
        add_filter('wfacp_body_class', array($this, 'goopter_ppcp_add_class_order_review_page'), 9999);
        add_filter('woocommerce_coupons_enabled', array($this, 'goopter_ppcp_woocommerce_coupons_enabled'), 999, 1);
        add_action('woocommerce_before_checkout_form', array($this, 'goopter_ppcp_order_review_page_description'), 9);
        add_action('woocommerce_before_checkout_form', array($this, 'goopter_ppcp_update_checkout_field_details'));
        add_action('wfacp_before_form', array($this, 'goopter_ppcp_update_checkout_field_details'), 1000);
        add_filter('woocommerce_checkout_get_value', array($this, 'goopter_ppcp_woocommerce_checkout_get_value'), 999, 2);

        add_action('woocommerce_review_order_before_submit', array($this, 'goopter_ppcp_cancel_button'), 999);
        add_filter('sgo_js_minify_exclude', array($this, 'goopter_ppcp_exclude_javascript'), 999);
        add_filter('sgo_javascript_combine_exclude', array($this, 'goopter_ppcp_exclude_javascript'), 999);
        add_filter('sgo_javascript_combine_excluded_inline_content', array($this, 'goopter_ppcp_exclude_javascript'), 999);
        add_filter('sgo_js_async_exclude', array($this, 'goopter_ppcp_exclude_javascript'), 999);
        add_action('woocommerce_pay_order_after_submit', array($this, 'goopter_ppcp_add_order_id'));
        add_filter('woocommerce_available_payment_gateways', array($this, 'goopter_ppcp_short_gateway'), 9999);

        add_filter('woocommerce_checkout_fields', array($this, 'goopter_ppcp_woocommerce_checkout_fields'), 999);
        //add_action('http_api_debug', array($this, 'goopter_ppcp_all_web_request'), 10, 5);
        add_action('woocommerce_review_order_before_order_total', array($this, 'goopter_ppcp_display_payment_method_title_review_page'));
        add_action('wp_loaded', array($this, 'goopter_ppcp_prevent_add_to_cart_woo_action'), 1);
        add_action('init', array($this, 'goopter_ppcp_woocommerce_before_checkout_process'), 0);
        add_filter('goopter_ppcp_paymentaction', array($this, 'goopter_ppcp_paymentaction_filter'), 10, 2);
        add_filter('goopter_ppcp_paymentaction_product_page', array($this, 'goopter_ppcp_paymentaction_product_page_filter'), 10, 2);
        add_shortcode('goopter_ppcp_smart_button', array($this, 'goopter_ppcp_display_paypal_smart_button_using_shortcode'), 9);
        add_action('woocommerce_get_checkout_url', array($this, 'goopter_ppcp_woocommerce_get_checkout_url'), 9999, 1);
        add_filter('goopter_ppcp_gateway_method_title', array($this, 'goopter_ppcp_gateway_method_title'), 999, 1);
        add_filter('woocommerce_get_credit_card_type_label', array($this, 'goopter_ppcp_woocommerce_get_credit_card_type_label'), 999, 1);
        add_filter('woocommerce_get_order_item_totals', array($this, 'goopter_ppcp_woocommerce_get_order_item_totals'), 999, 3);
        add_filter('woocommerce_locate_template', array($this, 'goopter_ppcp_woocommerce_locate_template'), 11, 3);
        add_filter('woocommerce_payment_methods_list_item', array($this, 'goopter_ppcp_woocommerce_payment_methods_list_item'), 10, 2);
        add_filter('woocommerce_subscription_payment_method_to_display', array($this, 'goopter_ppcp_woocommerce_subscription_payment_method_to_display'), 10, 2);
        add_action('wp', array($this, 'goopter_ppcp_delete_payment_method_action'), 9);
        add_action('woocommerce_checkout_init', array($this, 'goopter_ppcp_plugins_loaded'), 99);
        add_action('woocommerce_valid_order_statuses_for_payment_complete', array($this, 'goopter_ppcp_woocommerce_valid_order_statuses_for_payment_complete'), 10, 2);
        ...
        add_action('wp_head', [$this, 'goopter_load_js_sdk'], 100);
    ...
    public function goopter_load_js_sdk() {
        if (is_checkout() || is_checkout_pay_page()) {
            ...
            goopter_ppcp_add_css_js();
        } elseif (is_cart() && $this->enable_cart_button) {
            goopter_ppcp_add_css_js();
        }
    }
    ...
    public function goopter_ppcp_all_web_request($response, $response_text, $Requests_text, $parsed_args, $url) {
    ...
    private function getClientIdMerchantId() {
        ...
        if ($this->is_sandbox) {
            if ($this->is_first_party_used === 'yes') {
                ...
                $smart_js_arg['merchant-id'] = apply_filters('goopter_ppcp_merchant_id', $this->merchant_id);
            }
        } else {
            if ($this->is_first_party_used === 'yes') {
                $smart_js_arg['client-id'] = $this->client_id;
        ...
        $this->sdk_merchant_id = apply_filters('goopter_ppcp_merchant_id', $this->merchant_id);
    ...
    public function enqueue_scripts() {
        ...
        $this->goopter_ppcp_smart_button_style_properties();
        $default_country = wc_get_base_location();
        if (is_checkout() && goopter_ppcp_has_active_session() === true) {
        ...
        if (in_array($active_currency, $this->goopter_ppcp_currency_list)) {
            ...
            // wc_add_notice($active_currency . ' ' . __('currency is not supported.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
        ...
        wp_set_script_translations($this->goopter_ppcp_plugin_name . '-common-functions', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce', $dir_path);
        ...
        if (goopter_ppcp_has_active_session() === true || goopter_ppcp_is_subs_change_payment() === true) {
            if (is_product()) {
                $page = 'product';
            } else if (is_cart()) {
                $page = 'cart';
            ...
            if ($is_product_page_shortcode_used) {
                $shortcodes = goopter_get_matched_shortcode_attributes('product_page', $post->post_content);
                if (count($shortcodes)) {
            ...
            if (is_product() || $is_product_page_shortcode_used) {
                ...
                $this->paymentaction = apply_filters('goopter_ppcp_paymentaction_product_page', $this->paymentaction, $product_id);
                if (goopter_ppcp_is_product_purchasable($product, $this->enable_tokenized_payments) === true) {
                    $decimals = $this->payment_request->goopter_ppcp_get_number_of_decimal_digits();
                    $product_cart_amounts['totalAmount'] = goopter_ppcp_round($product->get_price(), $decimals);
                    $product_cart_amounts['shippingRequired'] = !$product->is_virtual();
                    $product_cart_amounts['lineItems'] = [[
                    'label' => $product->get_name(),
                    'amount' => goopter_ppcp_round($product->get_price(), $decimals)
                    ]];
                } else {
                ...
                $button_selector['goopter_ppcp_product'] = '#goopter_ppcp_product';
                $button_selector['goopter_ppcp_product_shortcode'] = '#goopter_ppcp_product_shortcode';
                $apple_pay_btn_selector['goopter_ppcp_product_shortcode_apple_pay'] = '#goopter_ppcp_product_shortcode_apple_pay';
                $apple_pay_btn_selector['goopter_ppcp_product_apple_pay'] = '#goopter_ppcp_product_apple_pay';
                $google_pay_btn_selector['goopter_ppcp_product_shortcode_google_pay'] = '#goopter_ppcp_product_shortcode_google_pay';
                $google_pay_btn_selector['goopter_ppcp_product_google_pay'] = '#goopter_ppcp_product_google_pay';
            } elseif (is_cart()) {
                $page = 'cart';
                if ($this->cart_button_position === 'top') {
                    $button_selector['goopter_ppcp_cart_top'] = '#goopter_ppcp_cart_top';
                    $apple_pay_btn_selector['goopter_ppcp_cart_top_apple_pay'] = '#goopter_ppcp_cart_top_apple_pay';
                    $google_pay_btn_selector['goopter_ppcp_cart_top_google_pay'] = '#goopter_ppcp_cart_top_google_pay';
                } else {
                    $button_selector['goopter_ppcp_cart'] = '#goopter_ppcp_cart';
                    $apple_pay_btn_selector['goopter_ppcp_cart_apple_pay'] = '#goopter_ppcp_cart_apple_pay';
                    $google_pay_btn_selector['goopter_ppcp_cart_google_pay'] = '#goopter_ppcp_cart_google_pay';
                    if ($this->cart_button_position === 'both') {
                        $button_selector['goopter_ppcp_cart_top'] = '#goopter_ppcp_cart_top';
                        $apple_pay_btn_selector['goopter_ppcp_cart_top_apple_pay'] = '#goopter_ppcp_cart_top_apple_pay';
                        $google_pay_btn_selector['goopter_ppcp_cart_top_google_pay'] = '#goopter_ppcp_cart_top_google_pay';
                ...
                $button_selector['goopter_ppcp_cart_shortcode'] = '#goopter_ppcp_cart_shortcode';
            } elseif (is_checkout_pay_page()) {
                $page = 'checkout';
                if ($this->checkout_page_display_option === 'regular') {
                    $button_selector['goopter_ppcp_checkout'] = '#goopter_ppcp_checkout';
                } else {
                    $button_selector['goopter_ppcp_checkout_top'] = '#goopter_ppcp_checkout_top';
                ...
                if ($this->checkout_page_display_option === 'top') {
                    $button_selector['goopter_ppcp_checkout_top'] = '#goopter_ppcp_checkout_top';
                    $apple_pay_btn_selector['goopter_ppcp_checkout_top_apple_pay'] = '#goopter_ppcp_checkout_top_apple_pay';
                    $google_pay_btn_selector['goopter_ppcp_checkout_top_google_pay'] = '#goopter_ppcp_checkout_top_google_pay';
            ...
            $smart_js_arg['commit'] = $this->goopter_ppcp_is_skip_final_review() ? 'true' : 'false';
            $smart_js_arg['intent'] = ($this->paymentaction === 'capture') ? 'capture' : 'authorize';
            $smart_js_arg['locale'] = Goopter_Utility::get_button_locale_code();
            ...
            if (goopter_ppcp_is_vault_required($this->enable_tokenized_payments)) {
                ...
                if (!empty($this->vault_not_supported_payment_method) && count($this->vault_not_supported_payment_method) > 0) {
                    // there is an issue when vault on, the paylater disapear in checkout page, to prevent this, don't add 'paylater' to disable-funding
                    $smart_js_arg['disable-funding'] = implode(',', array_diff($this->vault_not_supported_payment_method, ['credit', 'paylater']));
                }
            } else {
        ...
        if (!empty($components)) {
            $smart_js_arg['components'] = apply_filters('goopter_paypal_checkout_sdk_components', implode(',', $components));
        }
        ...
        wp_localize_script($goopter_script_loader_handle, 'goopter_ppcp_manager', array(
            ...
            'display_order_page' => add_query_arg(array('goopter_ppcp_action' => 'display_order_page', 'utm_nooverride' => '1'), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            'handle_js_errors' => add_query_arg(array('goopter_ppcp_action' => 'handle_js_errors', 'utm_nooverride' => '1'), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            'cc_capture' => add_query_arg(array('goopter_ppcp_action' => 'cc_capture', 'utm_nooverride' => '1'), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            'create_order_url' => add_query_arg(array('goopter_ppcp_action' => 'create_order', 'utm_nooverride' => '1', 'from' => is_checkout_pay_page() ? 'pay_page' : $page), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            'shipping_update_url' => add_query_arg(array('goopter_ppcp_action' => 'shipping_address_update', 'utm_nooverride' => '1', 'from' => is_checkout_pay_page() ? 'pay_page' : $page), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            ...
            'is_skip_final_review' => $this->goopter_ppcp_is_skip_final_review() ? 'yes' : 'no',
            'is_checkout_disable_smart_button' => ($this->checkout_disable_smart_button) ? 'yes' : 'no',
            'direct_capture' => add_query_arg(array('goopter_ppcp_action' => 'direct_capture', 'utm_nooverride' => '1'), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
            ...
            'goopter_cart_totals' => $product_cart_amounts,
            'update_cart_oncancel' => add_query_arg(array('goopter_ppcp_action' => 'update_cart_oncancel', 'utm_nooverride' => '1',), untrailingslashit(WC()->api_request_url('Goopter_PayPal_PPCP_Front_Action'))),
    ...
    public function enqueue_styles() {
        wp_register_style($this->goopter_ppcp_plugin_name, PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'ppcp-gateway/css/wc-gateway-ppcp-goopter-public' . $this->minified_version . '.css', array(), $this->version, 'all');
        $customCss = '';
        if (!empty($this->common_button_props['width'])) {
            $customCss .= '.goopter_ppcp-button-container #goopter_ppcp_product, .goopter_ppcp-button-container #goopter_ppcp_product_apple_pay, .goopter_ppcp-button-container #goopter_ppcp_product_google_pay, .goopter_ppcp-button-container #goopter_ppcp_cart, .goopter_ppcp-button-container #goopter_ppcp_cart_apple_pay, .goopter_ppcp-button-container #goopter_ppcp_cart_google_pay, .goopter_ppcp-button-container #goopter_ppcp_checkout, #goopter_ppcp_checkout_apple_pay, #goopter_ppcp_checkout_google_pay {width: ' . $this->common_button_props['width'] . 'px;}';
        }
        ...
        wp_add_inline_style($this->goopter_ppcp_plugin_name, $customCss);
        if (is_account_page()) {
            wp_enqueue_style($this->goopter_ppcp_plugin_name . '-myaccount', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'ppcp-gateway/css/goopter-ppcp-myaccount.css', array(), $this->version, 'all');
        }
        if (goopter_ppcp_has_active_session() && is_checkout()) {
            wp_enqueue_style($this->goopter_ppcp_plugin_name);
        }
    }
    ...
    public function display_paypal_button_cart_page($is_shortcode = "") {
        if (goopter_ppcp_is_cart_subscription() && $this->enable_tokenized_payments === false) {
            return false;
        }
        ...
        if (WC()->cart->needs_payment()) {
            ...
            if (!empty($available_gateways)) {
                $separator_html = '<div class="goopter_ppcp-proceed-to-checkout-button-separator">&mdash; ' . __('OR', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce') . ' &mdash;</div>';
            } else {
                $separator_html = '';
                $custom_css = "
                ...
                wp_add_inline_style('goopter_ppcp', $custom_css);
            }
            if ($is_shortcode === 'yes') {
                ...
                echo '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_cart"></div>';
                if ($this->advanced_card_payments) {
                    $this->form();
                }
                echo ($this->enable_apple_pay ? '<div id="goopter_ppcp_cart_apple_pay"></div>' : '') . ($this->enable_google_pay ? '<div id="goopter_ppcp_cart_google_pay"></div>' : '') , wp_kses_post($separator_html) . '</div>';
            }
        }
    }

    public function display_paypal_button_cart_page_top() {
        if (goopter_ppcp_is_cart_subscription()) {
            return false;
        }
        if (goopter_ppcp_get_order_total() === 0) {
            return false;
        ...
        if (WC()->cart->needs_payment()) {
            goopter_ppcp_add_css_js();
            echo '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_cart_top"></div>' . ($this->enable_apple_pay ? '<div id="goopter_ppcp_cart_top_apple_pay"></div>' : '') . ($this->enable_google_pay ? '<div id="goopter_ppcp_cart_top_google_pay"></div>' : '') . '</div>';
        }
    }
    ...
    public function display_paypal_button_top_checkout_page_stripe() {
        ...
        if (goopter_ppcp_has_active_session() === false) {
            $this->goopter_ppcp_smart_button_style_properties();
            if (WC()->cart->needs_payment()) {
                goopter_ppcp_add_css_js();
                echo wp_kses_post(
                    apply_filters(
                        ...
                        '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_checkout_top"></div>' . ($this->enable_apple_pay ? '<div id="goopter_ppcp_checkout_top_apple_pay"></div>' : '') . ($this->enable_google_pay ? '<div id="goopter_ppcp_checkout_top_google_pay"></div>' : '') . '</div>'
                    )
                );
            }
        }
                ...
                echo wp_kses_post(
                    apply_filters(
                        ...
                        '<div class="goopter_ppcp top_checkout_container_from_pfw">
                            <fieldset>
                                <legend class="express-title">' . esc_html__('PayPal Checkout', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce') . '</legend>
                                <div class="wc_ppcp_express_checkout_gateways">
                                    <div class="goopter_ppcp-gateway express_payment_method_ppcp">
                                        <div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '">
                                            <div id="goopter_ppcp_checkout_top"></div>
                                            <div id="goopter_ppcp_checkout_top_apple_pay"></div>
                                            <div id="goopter_ppcp_checkout_top_google_pay"></div>
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                            <span class="express-divider">OR</span>
                        </div>'
                    )
                );
            }
            ...
            if (WC()->cart->needs_payment()) {
                ...
                echo wp_kses_post(
                    apply_filters(
                        'goopter_ppcp_checkout_top_html',
                        '<div id="goopter_ppcp_checkout_top"></div>' . 
                        ($this->enable_apple_pay ? '<div id="goopter_ppcp_checkout_top_apple_pay"></div>' : '') . 
                        ($this->enable_google_pay ? '<div id="goopter_ppcp_checkout_top_google_pay"></div>' : '')
                    )
                );                
            }
        }
    ...
    public function display_paypal_button_product_page($is_shortcode = '') {
        try {
            ...
            if (goopter_ppcp_is_cart_contains_free_trial()) {
                return false;
            }
            $this->goopter_ppcp_smart_button_style_properties();
            if (goopter_ppcp_is_product_purchasable($product, $this->enable_tokenized_payments) === true) {
                goopter_ppcp_add_css_js();
                if ($is_shortcode === 'yes') {
                    echo '<div class="goopter_ppcp_smart_button_shortcode goopter_ppcp_product_page"><div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_product_shortcode"></div>' . ($this->enable_apple_pay ? '<div id="goopter_ppcp_product_shortcode_apple_pay"></div>' : '') . ($this->enable_google_pay ? '<div id="goopter_ppcp_product_shortcode_google_pay"></div>' : '') . '</div></div>';
                } else {
                    echo '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_product"></div>';
                    if ($this->advanced_card_payments) {
                        $this->form();
                    }
                    echo ($this->enable_apple_pay ? '<div id="goopter_ppcp_product_apple_pay"></div>' : '') . ($this->enable_google_pay ? '<div id="goopter_ppcp_product_google_pay"></div>' : '') . '</div>';
                }
            }
        } catch (Exception $ex) {
    ...
    public function form() {
        echo    
            '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '">
                <div id="goopter_ppcp_cc_product">
                    <div id="goopter_ppcp_cc_button"> 
                        <img class="goopter_ppcp_cc_button_logo" src="' . esc_attr(PAYPAL_FOR_WOOCOMMERCE_ASSET_URL) . 'ppcp-gateway/images/icon/credit-cards/credit-card.svg">
                        <span class="goopter_ppcp_cc_button_label">' . esc_attr($this->advanced_card_payments_title) . '</span></div>
                    <div class="goopter_ppcp_cc_container goopter_ppcp_cc_container_hide">
                        <button class="goopter_ppcp_cc_close_button" style="background: none; border: none; cursor: pointer; font-size: 1.5em;">✕</button>
                        <fieldset id="wc-goopter_ppcp_cc-form" class="wc-credit-card-form wc-payment-form">
                            <div id="goopter_ppcp_cc-card-number"></div>
                            <div id="goopter_ppcp_cc-card-expiry"></div>
                            <div id="goopter_ppcp_cc-card-cvc"></div>
                            <button id="goopter_ppcp_cc-card-submit-button" type="button">
                                Continue
                            </button>
                        </fieldset>
                    </div>
    ...
    public function display_paypal_button_checkout_page($is_shortcode = '') {
        ...
        if (goopter_ppcp_has_active_session() === false) {
            ...
            goopter_ppcp_add_css_js();
            if ($is_shortcode === 'yes') {
                echo '<div class="goopter_ppcp_smart_button_shortcode goopter_ppcp_checkout_page"><div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_checkout"></div></div></div>';
            } else {
                echo '<div class="goopter_ppcp-button-container goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '"><div id="goopter_ppcp_checkout" ></div></div>';
            }
        }
    }
    ...
    public function display_google_apple_pay_button_checkout_page() {
        ...
        if (goopter_ppcp_has_active_session() === false) {
            ...
            goopter_ppcp_add_css_js();
            if ($this->enable_apple_pay) {
                echo '<div id="goopter_ppcp_checkout_apple_pay" class="goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '" style=""></div>';
            }
            if ($this->enable_google_pay) {
                echo '<div id="goopter_ppcp_checkout_google_pay" class="goopter_ppcp_' . esc_attr($this->style_layout) . '_' . esc_attr($this->style_size) . '" style=""></div>';
            }
        }
    }

    public function goopter_ppcp_endpoint_page_titles($title) {
        if (!is_admin() && is_main_query() && in_the_loop() && is_page() && is_checkout() && goopter_ppcp_has_active_session() === true) {
            $title = $this->order_review_page_title;
            remove_filter('the_title', array($this, 'goopter_ppcp_endpoint_page_titles'));
        }
        return $title;
    }

    public function goopter_ppcp_checkout_init($checkout) {
    ...
    public function paypal_billing_details() {
        ...
        $billing_edit_link = "&nbsp;&nbsp;&nbsp;<a class='goopter_ppcp_edit_billing_address'>" . __('Edit', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce') . "</a>";
        ?>
        <div class="goopter_ppcp_billing_details">
        <?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) { ?>
                <h3><?php esc_html_e('Billing &amp; Shipping', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'); ?> <?php echo esc_url($billing_edit_link); ?></h3>
            <?php } else { ?>
                <h3>
                <?php
                esc_html_e('Billing details', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
                ...
                $checkout_details = goopter_ppcp_get_mapped_billing_address($this->checkout_details, !$this->set_billing_address);
                echo wp_kses_post(WC()->countries->get_formatted_address($checkout_details));
                echo !empty($checkout_details['email']) 
                    ? '<p class="goopter-woocommerce-customer-details-email">' . esc_html($checkout_details['email']) . '</p>' 
                    : '';
                echo !empty($checkout_details['phone']) 
                    ? '<p class="goopter-woocommerce-customer-details-phone">' . esc_html($checkout_details['phone']) . '</p>' 
                    : '';
                ?>
        </div>
            <?php
        ...
        public function account_registration() {
            ...
            if (!is_user_logged_in() && $checkout->enable_signup) {
                ...
                <p class="form-row form-row-wide create-account">
                    ...
                    <label for="createaccount" class="checkbox">
                        <?php esc_html_e( 'Create an account?', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ); ?>
                    </label>
                </p>
                <?php
            }
            if (!empty($checkout->checkout_fields['account'])) {
                ...
                <div class="create-account">
                    <p>
                        <?php esc_html_e( 'Create an account by entering the information below. If you are a returning customer please login at the top of the page.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ); ?>
                    </p>
    ...
    public function maybe_disable_other_gateways($gateways) {
        ...
        if (is_add_payment_method_page()) {
            unset($gateways['goopter_ppcp_apple_pay']);
            unset($gateways['goopter_ppcp_google_pay']);
        }

        // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- no security issue
        if (goopter_ppcp_has_active_session() === false || (isset($_GET['from']) && 'checkout' === $_GET['from'])) {
            return $gateways;
        }
        foreach ($gateways as $id => $gateway) {
            if ('goopter_ppcp' !== $id && 'goopter_ppcp_apple_pay' !== $id && 'goopter_ppcp_cc' !== $id && 'goopter_ppcp_google_pay' !== $id) {
                unset($gateways[$id]);
            }
        }
        if (is_cart() || ( is_checkout() && !is_checkout_pay_page() )) {
            ...
            if (WC()->cart->total <= 0) {
                unset($gateways['goopter_ppcp']);
                unset($gateways['goopter_ppcp_apple_pay']);
                unset($gateways['goopter_ppcp_google_pay']);
                unset($gateways['goopter_ppcp_cc']);
            }
        }
        return $gateways;
    }
    ...
    public function copy_checkout_details_to_post() {
        if (empty($this->checkout_details)) {
            ...
            if (empty($this->checkout_details)) {
                ...
                if (!empty($_GET['paypal_order_id'])) {
                    $this->checkout_details = $this->payment_request->goopter_ppcp_get_checkout_details(sanitize_text_field(wp_unslash($_GET['paypal_order_id'])));
                }
        ...
        if (!isset($_POST['payment_method']) || ( 'goopter_ppcp' !== $_POST['payment_method'] ) || empty($this->checkout_details)) {
            return;
        }
        $shipping_details = goopter_ppcp_get_mapped_shipping_address($this->checkout_details);
        $billing_details = goopter_ppcp_get_mapped_billing_address($this->checkout_details, !$this->set_billing_address);
    ...
    public function maybe_add_shipping_information($packages) {
        ...
        $destination = goopter_ppcp_get_mapped_shipping_address($this->checkout_details);
    ...
    public function filter_wc_checkout_params($params, $handle = '') {
        ...
        foreach ($fields as $field) {
            ...
            if (!empty($_GET[$field])) {
                $params['wc_ajax_url'] = add_query_arg($field, sanitize_text_field(wp_unslash($_GET[$field])), $params['wc_ajax_url']);
            }
    ...
    public function goopter_ppcp_session_manager() {
        try {
            // phpcs:disable WordPress.Security.NonceVerification.Recommended -- no security issue
            ...
            if (!empty($_GET['paypal_order_id'])) {
                ...
                if (empty($this->checkout_details)) {
                    $this->checkout_details = Goopter_Session_Manager::get('paypal_transaction_details', false);
    ...
    public function goopter_ppcp_add_class_order_review_page($classes) {
        try {
            if (!class_exists('WooCommerce') || WC()->session == null) {
                return $classes;
            }
            if (goopter_ppcp_has_active_session()) {
                $classes[] = 'goopter_ppcp-order-review';
            // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- no security issue
    ...
    public function goopter_ppcp_woocommerce_coupons_enabled($bool) {
        if (goopter_ppcp_has_active_session()) {
    ...
    public function goopter_ppcp_order_review_page_description() {
        if ($this->order_review_page_description && goopter_ppcp_has_active_session()) { ?>
    ...
    public function get_paypal_sdk_attributes(): array {
        ...
        if (!isset($_GET['paypal_order_id'])) {
            ...
            if (!is_add_payment_method_page() && $this->enable_tokenized_payments && is_user_logged_in()) {
                $clientToken = $this->payment_request->goopter_ppcp_get_generate_id_token();
     ...
     */
    public function goopter_ppcp_clean_url($tag, $handle) {
        $data_merchant_id = '';
        if ('goopter-paypal-checkout-sdk' === $handle) {
            $data_merchant_id = '';
            if (!empty($this->sdk_merchant_id)) {
                if (is_array($this->sdk_merchant_id) && count($this->sdk_merchant_id) > 0) {
                    $sdk_merchant_id_string = implode(',', $this->sdk_merchant_id);
        ...
        if ('goopter-paypal-checkout-sdk-disable' === $handle) {
            $client_token = '';
            $user_id_token = '';
            // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- no security issue
            if (!isset($_GET['paypal_order_id'])) {
             ...
             $tag = str_replace(' src=', ' ' . $client_token . $user_id_token . $data_merchant_id . ' data-namespace="goopter_paypal_sdk" src=', $tag);
        }
        return $tag;
    }

    public function goopter_ppcp_update_checkout_field_details() {
        if (empty($this->checkout_details)) {
            $this->checkout_details = Goopter_Session_Manager::get('paypal_transaction_details');
            if (empty($this->checkout_details)) {
                // phpcs:disable WordPress.Security.NonceVerification.Recommended -- no security issue
        ...
        if (!empty($this->checkout_details)) {
            $shipping_address = goopter_ppcp_get_mapped_shipping_address($this->checkout_details);
            if (!empty($shipping_address)) {
                foreach ($shipping_address as $field => $value) {
                    if (!empty($value)) {
                        if ('state' == $field) {
                            if (goopter_ppcp_validate_checkout($shipping_address['country'], $value, 'shipping')) {
                                $_POST['shipping_' . $field] = goopter_ppcp_validate_checkout($shipping_address['country'], $value, 'shipping');
                            } else {
            ...
            $billing_address = goopter_ppcp_get_mapped_billing_address($this->checkout_details, !$this->set_billing_address);
                    ...
                    if (!empty($value)) {
                        if ('state' == $field) {
                            if (!empty($shipping_address['country'])) {
                                if (goopter_ppcp_validate_checkout($shipping_address['country'], $value, 'shipping')) {
                                    $_POST['billing_' . $field] = goopter_ppcp_validate_checkout($shipping_address['country'], $value, 'shipping');
                                } else {
                                    if (isset($shipping_address['country']) && isset($states_list[$shipping_address['country']])) {
                                        $state_key = array_search($value, $states_list[$shipping_address['country']]);
    ...
    public function goopter_ppcp_cancel_button() {
        if (goopter_ppcp_has_active_session()) {
            $order_button_text = __('Cancel order', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
            ...
            echo wp_kses_post(
                apply_filters(
                    'goopter_ppcp_review_order_cance_button_html',
                    '<a class="button alt goopter_ppcp_cancel" name="woocommerce_checkout_cancel_order" href="' . esc_url($cancel_order_url) . '">' . esc_html($order_button_text) . '</a>'
                )
            );
        }
    }

    public function goopter_ppcp_exclude_javascript($excluded_handles) {
        $excluded_handles[] = 'jquery-core';
        $excluded_handles[] = 'wp-i18n';
        $excluded_handles[] = 'goopter_ppcp-common-functions';
        $excluded_handles[] = 'goopter_ppcp-apple-pay';
        $excluded_handles[] = 'goopter_ppcp-google-pay';
        $excluded_handles[] = 'goopter_ppcp';
        $excluded_handles[] = 'goopter-paypal-checkout-sdk';
        $excluded_handles[] = 'goopter_ppcp-order-review';
        $excluded_handles[] = 'goopter_ppcp-order-capture';
        $excluded_handles[] = 'goopter-pay-later-messaging-home';
        $excluded_handles[] = 'goopter-pay-later-messaging-category';
        $excluded_handles[] = 'goopter-pay-later-messaging-product';
        $excluded_handles[] = 'goopter-pay-later-messaging-cart';
        $excluded_handles[] = 'goopter-pay-later-messaging-payment';
        $excluded_handles[] = 'goopter-pay-later-messaging-shortcode';
        return $excluded_handles;
    }

    public function goopter_ppcp_add_order_id() {
        global $wp;
    ...
    public function goopter_ppcp_short_gateway($methods) {
        // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- no security issue
        if (goopter_ppcp_has_active_session() === true || isset($_GET['paypal_order_id'])) {
            ...
            $payment_method_used = Goopter_Session_Manager::get('used_payment_method');
            foreach ($methods as $key => $method) {
                if ($payment_method_used == 'apple_pay' && $key !== 'goopter_ppcp_apple_pay') {
                    unset($methods[$key]);
                } else if ($payment_method_used != 'apple_pay' && $key == 'goopter_ppcp_apple_pay') {
                    unset($methods[$key]);
                } else if ($payment_method_used == 'google_pay' && $key !== 'goopter_ppcp_google_pay') {
                    unset($methods[$key]);
                } else if ($payment_method_used != 'google_pay' && $key == 'goopter_ppcp_google_pay') {
                    unset($methods[$key]);
                }
        ...
        if (is_add_payment_method_page()) {
            unset($methods['goopter_ppcp_google_pay']);
            unset($methods['goopter_ppcp_apple_pay']);
        }
        return $methods;
    }

    public function goopter_ppcp_woocommerce_checkout_fields($fields) {
            ...
            if (!empty($this->checkout_details)) {
                if (!empty($fields['billing'])) {
                    foreach ($fields['billing'] as $key => $value) {
                        if (!in_array($key, apply_filters('goopter_required_billing_fields', array('billing_first_name', 'billing_last_name', 'billing_email')))) {
            ...
            if (!empty($shipping_address) && !empty($fields['shipping'])) {
                foreach ($fields['shipping'] as $field => $value) {
                    ...
                    if (isset($value['required']) && $value['required'] === true && array_key_exists($address_key, $shipping_address) && empty($shipping_address[$address_key])) {
                        ...
                        $fields['shipping'][$field]['class'][0] = $fields['shipping'][$field]['class'][0] . ' goopter_ppcp_shipping_hide';
                    }
                }
            }
            $billing_address = goopter_ppcp_get_mapped_billing_address($this->checkout_details, !$this->set_billing_address);
            if (!empty($billing_address) && !empty($fields['billing'])) {
                foreach ($fields['billing'] as $field => $value) {
                    ...
                    if (isset($value['required']) && $value['required'] === true && array_key_exists($address_key, $billing_address) && empty($billing_address[$address_key])) {
                        ...
                        $fields['billing'][$field]['class'][0] = $fields['billing'][$field]['class'][0] . ' goopter_ppcp_billing_hide';
                    }
                }
            }
        }
    ...
    public function goopter_ppcp_prepare_order_data($defaultData = []) {
        if (empty($this->checkout_details)) {
            $this->checkout_details = Goopter_Session_Manager::get('paypal_transaction_details');
            if (empty($this->checkout_details)) {
                $goopter_ppcp_paypal_order_id = Goopter_Session_Manager::get('paypal_order_id');
                if (!empty($goopter_ppcp_paypal_order_id)) {
                    $this->checkout_details = $this->payment_request->goopter_ppcp_get_checkout_details($goopter_ppcp_paypal_order_id);
                }
            }
            if (empty($this->checkout_details)) {
                return $defaultData;
        ...
        if (isset($_POST)) {
            $look_for_keys_post = ['createaccount', 'terms',
                'wc-goopter_ppcp_cc-new-payment-method', 'wc-goopter_ppcp_cc-payment-token',
                'wc-goopter_ppcp-new-payment-method', 'wc-goopter_ppcp-payment-token',
        ...
        switch ($payment_method_used) {
            case 'apple_pay':
                $order_data['payment_method'] = 'goopter_ppcp_apple_pay';
                break;
            case 'google_pay':
                $order_data['payment_method'] = 'goopter_ppcp_google_pay';
                break;
            default:
                $order_data['payment_method'] = 'goopter_ppcp';
        }
        ...
        if (isset($goopter_ppcp_checkout_post)) {
            // Fill the data if it's not available in $order_data
            foreach ($goopter_ppcp_checkout_post as $key => $value) {
    ...
    public function goopter_ppcp_is_skip_final_review() {
        if (is_checkout() || is_checkout_pay_page()) {
            if (class_exists('WFFN_Core')) {
                return apply_filters('goopter_ppcp_skip_final_review', false);
            }
            return apply_filters('goopter_ppcp_skip_final_review', true);
        }
        ...
        $goopter_ppcp_checkout_post = goopter_get_session('goopter_ppcp_checkout_post');
        if (apply_filters('woocommerce_checkout_show_terms', true) && function_exists('wc_terms_and_conditions_checkbox_enabled') && wc_terms_and_conditions_checkbox_enabled()) {
            if ($this->disable_term) {
                return apply_filters('goopter_ppcp_skip_final_review', true);
            } elseif ((isset($goopter_ppcp_checkout_post['terms']) || isset($goopter_ppcp_checkout_post['legal'])) && $goopter_ppcp_checkout_post['terms'] == 'on') {
                return apply_filters('goopter_ppcp_skip_final_review', true);
            } else {
                return apply_filters('goopter_ppcp_skip_final_review', false);
            }
        ...
        return apply_filters('goopter_ppcp_skip_final_review', $force_to_skip_final_review);
    }

    public function goopter_ppcp_display_payment_method_title_review_page() {
        ...
        if (!empty($goopter_ppcp_payment_method_title)) {
            ...
            <tr id="goopter_order_review_payment_method">
                <th><?php esc_html_e('Payment method:', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'); ?></th>
    ...
    public function goopter_ppcp_woocommerce_before_checkout_process() {
        ...
        if (isset($_POST['_wcf_checkout_id']) && isset($_POST['_wcf_flow_id'])) {
            ...
            $_GET['wcf_checkout_id'] = sanitize_text_field(wp_unslash($_POST['_wcf_checkout_id']));
            wc_maybe_define_constant('DOING_AJAX', true);
            wc_maybe_define_constant('WC_DOING_AJAX', true);
        } elseif (isset($_POST['woocommerce-process-checkout-nonce']) && wp_verify_nonce(sanitize_key(wp_unslash($_POST['woocommerce-process-checkout-nonce'])))) {
            $_GET['wc-ajax'] = 'checkout';
        }
    }

    public function goopter_ppcp_paymentaction_filter($paymentaction, $order_id) {
        try {
            ...
            if ($order_id !== null) {
                $order = wc_get_order($order_id);
                if ($order) {
                    $paymentaction_val = goopter_ppcp_get_post_meta($order, '_paymentaction');
    ...
    public function goopter_ppcp_paymentaction_product_page_filter($paymentaction, $product_id) {
        try {
    ...
    public function goopter_ppcp_display_paypal_smart_button_using_shortcode() {
        try {
            if (is_product()) {
    ...
    public function goopter_ppcp_woocommerce_get_checkout_url($checkout_url) {
        ...
        try {
            if (is_checkout() && goopter_ppcp_has_active_session()) {
                ...
                if (isset($_GET['paypal_order_id'])) {
                    $checkout_url_parameter['paypal_order_id'] = wc_clean(sanitize_text_field(wp_unslash($_GET['paypal_order_id'])));
                }
                if (isset($_GET['paypal_payer_id'])) {
                    $checkout_url_parameter['paypal_payer_id'] = wc_clean(sanitize_text_field(wp_unslash($_GET['paypal_payer_id'])));
                }
                if (isset($_GET['from'])) {
                    $checkout_url_parameter['from'] = wc_clean(sanitize_text_field(wp_unslash($_GET['from'])));
                }
    ...
    public function goopter_ppcp_gateway_method_title($method_title) {
        // phpcs:disable WordPress.Security.NonceVerification.Recommended -- no security issue
        if (is_admin() && isset($_GET['post']) && !empty($_GET['post'])) {
            $payment_method_title = goopter_ppcp_get_post_meta(wc_clean(sanitize_text_field(wp_unslash($_GET['post']))), '_goopter_ppcp_used_payment_method', true);
            if (!empty($payment_method_title)) {
                $payment_method_title = goopter_ppcp_get_payment_method_title($payment_method_title);
                if (!empty($payment_method_title)) {
    ...
    public function goopter_ppcp_woocommerce_get_credit_card_type_label($type) {
    ...
    public function goopter_ppcp_woocommerce_get_order_item_totals($total_rows, $order, $tax_display) {
        if (!$order->get_id()) {
            return $total_rows;
        }
        $payment_method_title = goopter_ppcp_get_post_meta($order, '_goopter_ppcp_used_payment_method', true);
        if (!empty($payment_method_title)) {
            $payment_method_title = goopter_ppcp_get_payment_method_title($payment_method_title);
            if (!empty($payment_method_title)) {
    ...
    public function goopter_ppcp_woocommerce_currency($currency) {
        try {
    ...
    public function goopter_ppcp_plugins_loaded() {
        try {
    ...
    public function goopter_ppcp_woocommerce_locate_template($template, $template_name, $template_path) {
        global $woocommerce;
    ...
    public function goopter_ppcp_woocommerce_payment_methods_list_item($list, $payment_token) {
        if (null !== $payment_token->get_id()) {
            $used_payment_method = get_metadata('payment_token', $payment_token->get_id(), '_goopter_ppcp_used_payment_method', true);
            if (!empty($used_payment_method)) {
                $list['_goopter_ppcp_used_payment_method'] = $used_payment_method;
    ...
    public function goopter_ppcp_woocommerce_subscription_payment_method_to_display($payment_method_to_display, $subscription) {
        $goopter_ppcp_used_payment_method = $subscription->get_meta('_goopter_ppcp_used_payment_method', true);
    ...
    public function goopter_ppcp_delete_payment_method_action() {
        try {
            global $wp;
            if (isset($wp->query_vars['delete-payment-method'])) {
                ...
                if (is_null($token) || get_current_user_id() !== $token->get_user_id() || !isset($_REQUEST['_wpnonce']) || false === wp_verify_nonce(sanitize_text_field(wp_unslash($_REQUEST['_wpnonce'])), 'delete-payment-method-' . $token_id)) {
                    wc_add_notice(__('Invalid payment method.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'), 'error');
                } else {
                    ...
                    wc_add_notice(__('Payment method deleted.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
                }
    ...
    public function add_cart_data_in_html() {
        ...
        echo '<div id="goopter_cart_totals" style="display:none;">' . wp_kses_post($fragments['goopter_payments_data']) . '</div>';
    }

    public function goopter_ppcp_woocommerce_valid_order_statuses_for_payment_complete($order_status_list, $order) {
    ...
    public function goopter_ppcp_block_set_address() {
        if (empty($this->checkout_details)) {
            $this->checkout_details = Goopter_Session_Manager::get('paypal_transaction_details');
            if (empty($this->checkout_details)) {
                // phpcs:disable WordPress.Security.NonceVerification.Recommended -- no security issue
    ...
    public function goopter_ppcp_disable_instant_order_confirmation($bool, $order) {
        if ( is_numeric( $order ) ) {
		$order = wc_get_order( $order );
	}
        $payment_method = $order->get_payment_method();
        if (strpos($payment_method, 'goopter') !== false) {
            return false; 
        }
        return $bool;
    }
