    ...
    private function default_data() {
        ...
        $default_data = array(
            ...
            'return_url_description' => __(
                    'Return to your shop.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'
            ),
            'products' => array(
    ...
    public function goopter_ppcp_listen_for_merchant_id() {
        ...
        try {
            ...
            if (isset($_GET['place']) && $_GET['place'] === 'gateway_settings') {
                ...
                $redirect_url = admin_url('options-general.php?page=goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
            }
            unset($_GET);
