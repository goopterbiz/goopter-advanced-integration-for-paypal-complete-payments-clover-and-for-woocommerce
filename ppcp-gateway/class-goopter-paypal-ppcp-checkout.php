        ...
        public function process_checkout() {
            try {
                ...
                if (WC()->cart->is_empty()) {
                    ...
                    throw new Exception(sprintf(__('Sorry, your session has expired. <a href="%s" class="wc-backward">Return to shop</a>', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'), esc_url(wc_get_page_permalink('shop'))));
                }
                ...
                if (empty($posted_data['woocommerce_checkout_update_totals']) && 0 === wc_notice_count('error')) {
                    ...
                    if (!$order) {
                        throw new Exception(__('Unable to create order.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
                    }
        ...
        public function goopter_ppcp_create_order() {
            ...
            if (WC()->cart->is_empty()) {
                throw new Exception(wp_kses_post(sprintf(
                    // Translators: %s is the URL to the shop page.
                    __('Sorry, your session has expired. <a href="%s" class="wc-backward">Return to shop</a>', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
            ...
            if (empty($posted_data['woocommerce_checkout_update_totals']) && 0 === wc_notice_count('error')) {
                ...
                if (!$order) {
                    throw new Exception(esc_html__('Unable to create order.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
                }
                /**
                ...
                throw new Exception(esc_html__('Unable to create order due to following errors.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'));
            }
        }
    }
