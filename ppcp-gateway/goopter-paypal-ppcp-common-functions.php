...
if (!function_exists('goopter_ppcp_get_payment_method_title')) {
    ...
    function goopter_ppcp_get_payment_method_title($payment_name = '') {
        ...
        $list_payment_method = array(
            ...
            'paylater' => __('PayPal Pay Later', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
            'paypal' => __('PayPal Checkout', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
            'apple_pay' => __('Apple Pay', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
            'google_pay' => __('Google Pay', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
        );
