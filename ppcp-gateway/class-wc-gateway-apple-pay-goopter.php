...
class Goopter_WC_Gateway_Apple_Pay extends Goopter_WC_Gateway_PPCP {
    ...
    public function __construct() {
        ...
        try {
            ...
            $this->method_description = __('Accept payments using Apple Pay.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
            ...
            $this->method_title = apply_filters('goopter_ppcp_gateway_method_title', $this->setting_obj->get('apple_pay_payments_title', 'Apple Pay'));
    ...
    public function form() {
        try {
            ?>
            <?php 
                $description = $this->apple_pay_payments_description ?: __('Default Apple Pay description', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce');
