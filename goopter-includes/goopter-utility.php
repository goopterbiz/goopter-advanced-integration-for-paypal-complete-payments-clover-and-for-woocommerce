...
class Goopter_Utility {
    ...
    public function paypal_for_woocommerce_paypal_transaction_history() {
        ...
        register_post_type('paypal_transaction', apply_filters('goopter_paypal_for_woocommerce_register_post_type_paypal_transaction_history', array(
            'labels' => array(
                'name' => __('PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'singular_name' => __('PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'menu_name' => _x('PayPal Transaction', 'Admin menu name', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'add_new' => __('Add PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'add_new_item' => __('Add New PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'edit' => __('Edit', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'edit_item' => __('View PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'new_item' => __('New PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'view' => __('View PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'view_item' => __('View PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'search_items' => __('Search PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'not_found' => __('No PayPal Transaction found', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'not_found_in_trash' => __('No PayPal Transaction found in trash', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
                'parent' => __('Parent PayPal Transaction', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce')
            ),
            'description' => __('This is where you can add new PayPal Transaction to your store.', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce'),
            'public' => false,
            'query_var' => false,
        )));
    }
    ...
    public function save($post_id, $post_or_order_object) {
        ...
        public function goopter_paypal_for_woocommerce_billing_agreement_details($order) {
            ...
            ?>
        <h3>
            <?php esc_html_e( 'Billing Agreement Details', 'goopter-advanced-integration-for-paypal-complete-payments-clover-and-for-woocommerce' ); ?>
        </h3>
